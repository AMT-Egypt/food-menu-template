...
import { burgersAr } from "./burger/burgerAr";
import { iceCreamAr } from "./iceCream/iceCreamAr";
import { pastaAr } from "./pasta/pastaAr";
import { allPizzaAr } from "./pizza/pizzaAr";
import { saladAr } from "./salad/saladAr";
import { sushiAr } from "./sushi/sushiAr";

export const allDataAr: oneFoodType[][] = [
    [
        {
